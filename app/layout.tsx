...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body><LanguageProvider><GlobalUiI18n/><AuthProvider><ThemeProvider><LivePlatformSync/><SiteAtmosphere/><Header/><SupportWidget/><MaintenanceGate>{children}</MaintenanceGate><ScrollToTop/></ThemeProvider></AuthProvider></LanguageProvider></body></html>}
