...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  if (!user) return NextResponse.json({ error: "Р’РѕР№РґРёС‚Рµ РІ Р°РєРєР°СѓРЅС‚", errorCode: "AUTH_REQUIRED" }, { status: 401 });
  try {
    ...
    const result = await prisma.$transaction(async tx => {
      ...
      const claim=await tx.match.updateMany({where:{id,status:"LIVE"},data:{winnerId,loserId,status:"FINISHED",endedAt:new Date(),connectionPhaseCompleted:true,connectionDeadlineAt:null,liveDeadlineAt:null}});
      ...
      await tx.notification.create({ data: { userId: winnerId, type: "WIN", title: "РџРѕР±РµРґР° РІ С‚РµСЃС‚РѕРІРѕР№ РґСѓСЌР»Рё", body: `РўРµСЃС‚РѕРІС‹Р№ РјР°С‚С‡ Р·Р°РІРµСЂС€С‘РЅ. РќР°С‡РёСЃР»РµРЅРѕ $${payout.toFixed(2)}.`, payload: { matchId: match.id, payout, localTest: true } } });
      await tx.notification.create({ data: { userId: loserId, type: "LOSS", title: "РўРµСЃС‚РѕРІС‹Р№ РјР°С‚С‡ Р·Р°РІРµСЂС€С‘РЅ", body: "РџРѕР±РµРґРёС‚РµР»СЊ РІС‹Р±СЂР°РЅ РІ Р»РѕРєР°Р»СЊРЅРѕРј С‚РµСЃС‚РѕРІРѕРј СЂРµР¶РёРјРµ.", payload: { matchId: match.id, localTest: true } } });
    ...
    const errors: Record<string, [string, number]> = {
      NOT_FOUND: ["РњР°С‚С‡ РЅРµ РЅР°Р№РґРµРЅ", 404],
      NOT_LOCAL_TEST: ["Р›РѕРєР°Р»СЊРЅС‹Р№ С‚РµСЃС‚РѕРІС‹Р№ СЂРµР¶РёРј РґР»СЏ СЌС‚РѕРіРѕ РјР°С‚С‡Р° РЅРµРґРѕСЃС‚СѓРїРµРЅ", 409],
      TEST_ONLY: ["Р›РѕРєР°Р»СЊРЅС‹Р№ С‚РµСЃС‚ РґРѕСЃС‚СѓРїРµРЅ С‚РѕР»СЊРєРѕ РґРІСѓРј С‚РµСЃС‚РѕРІС‹Рј Р°РєРєР°СѓРЅС‚Р°Рј", 403],
      FORBIDDEN: ["Р’С‹ РЅРµ СѓС‡Р°СЃС‚РЅРёРє РјР°С‚С‡Р°", 403],
      INVALID_STATUS: ["РњР°С‚С‡ СѓР¶Рµ Р·Р°РІРµСЂС€С‘РЅ РёР»Рё РµС‰С‘ РЅРµ Р·Р°РїСѓС‰РµРЅ", 409],
      INVALID_WINNER: ["РџРѕР±РµРґРёС‚РµР»СЊ РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ СѓС‡Р°СЃС‚РЅРёРєРѕРј РјР°С‚С‡Р°", 400],
      WALLET: ["РљРѕС€РµР»С‘Рє РёРіСЂРѕРєР° РЅРµ РЅР°Р№РґРµРЅ", 500],
      LOCKED_STAKE: ["Р—Р°Р±Р»РѕРєРёСЂРѕРІР°РЅРЅР°СЏ СЃС‚Р°РІРєР° РјР°С‚С‡Р° РїРѕРІСЂРµР¶РґРµРЅР°", 409],
    };
    const [message, status] = errors[code] ?? ["РќРµ СѓРґР°Р»РѕСЃСЊ Р·Р°РІРµСЂС€РёС‚СЊ Р»РѕРєР°Р»СЊРЅС‹Р№ С‚РµСЃС‚", 500];
