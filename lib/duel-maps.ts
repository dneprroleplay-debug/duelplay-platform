...
export const DUEL_MAPS: readonly DuelMapConfig[] = [
  ...
  {
    id: "aim_cache", displayName: "AIM Cache", serverMapName: "aim_cache",
    image: "/images/maps/aim_redline.png", workshopId: "3754320383", category: "AIM",
    description: "Cache-inspired aim arena for fast head-to-head duels.",
    supportedModes: ALL_GAMEPLAY,
    requiresManualInstall: true,
  },
  {
    id: "fy_snow", displayName: "Fy Snow", serverMapName: "fy_snow",
    image: "/images/maps/pool_day_classic.png", workshopId: "3592238209", category: "CLASSIC",
    description: "Compact snowy fight-yard style arena for quick duels.",
    supportedModes: ALL_GAMEPLAY,
    requiresManualInstall: true,
  },
  {
    id: "one_vs_one_aim_map_arena", displayName: "1vs1 Aim Map Arena", serverMapName: "1vs1_aim_map_arena",
    image: "/images/maps/one_v_one_arena.png", workshopId: "3383710636", category: "ARENA",
    description: "Circular desert-style arena designed for direct 1v1 fights.",
    supportedModes: ALL_GAMEPLAY,
    requiresManualInstall: true,
  },
  {
