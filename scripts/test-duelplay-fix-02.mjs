...
const checks = [
  ...
  [
    '5-minute no-connection timeout creates a cancellation notification',
    lifecycle.includes('cancelMatchWithRefund(m.id, "No player connected within 5 minutes")'),
  ],
  [
    '5-minute cancellation notification has a visible specific body',
