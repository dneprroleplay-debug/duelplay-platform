...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  // Keep the initial render deterministic on both server and client. Reading
  // localStorage inside the state initializer makes the client render a
  // different language than the server and causes React hydration errors.
