 ...
 const noticeTitle=(n:Notice)=>{
  ...
  const titles:any={
    ...
    PL:{
      ...
      TRANSACTION_SUCCESS:"Transakcja zako?czona",
 ...
 const noticeBody=(n:Notice)=>{
  ...
  const bodies:any={
    ...
    PL:{
      ...
      MATCH_READY:"Mecz jest gotowy do rozpocz?cia.",
      TRANSACTION_SUCCESS:"Transakcja zosta?a pomy?lnie zako?czona.",
      TRANSACTION_FAILED:"Transakcja nie powiod?a si?.",
      DISPUTE_UPDATE:"Dost?pna jest aktualizacja sporu.",
      PROMO_ACTIVATED:"Kod promocyjny zosta? aktywowany.",
